...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { category: @discount.category, end_date: @discount.end_date, name: @discount.name, start_date: @discount.start_date } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { category: @discount.category, end_date: @discount.end_date, name: @discount.name, start_date: @discount.start_date } }
