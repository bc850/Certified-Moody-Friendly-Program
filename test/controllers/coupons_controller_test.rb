...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { category: @coupon.category, description: @coupon.description, end_date: @coupon.end_date, location: @coupon.location, name: @coupon.name, start_date: @coupon.start_date } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { category: @coupon.category, description: @coupon.description, end_date: @coupon.end_date, location: @coupon.location, name: @coupon.name, start_date: @coupon.start_date } }
